...
public abstract class ResponseCallback<T, E>  implements Callback, IGenericsConvert<E> {
     ...
     * 一个tag 一个文件名称
     */
    public void onStart(Object tag,String fileName) {
    }
     ...
     * @param
     */
    public void onCompleted(Object tag,String fileName) {
    }
    ...
    /*文件下载传递自己的设定的文件名称*/
    public abstract void onGyNext(Object tag, String fileName, T response);
   ...
   protected void finalOnError(final Exception e) {
    ...
    public static ResponseCallback CALLBACK_DEFAULT = new ResponseCallback() {
        ...
        @Override
        public void onGyNext(Object tag, String fileName, Object response) {
