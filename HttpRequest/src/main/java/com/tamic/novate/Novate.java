...
*/
     ...
     * @param callBack
     */
    public <T> T rxGyDownload(String url,String fileName, final ResponseCallback callBack) {
        /*标志 下载文件url 保存文件名称*/
        return rxGyDownload(url, url,fileName, callBack);
    }
    ...
    public <T> T rxGyDownload(Object tag, String url,String fileName, final ResponseCallback callBack) {
