...
import com.system.translationpen.hotspot.untils.Constant;
...
public class EnterBlueNameActivity extends BaseTitleActivity {
    ...
    protected void onInitData() {
        setTitle(R.drawable.retur,getHintMessage(4),0);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            case R.id.btn_sure:
                ...
                intent.putExtra("blue_name",et_wifi_name.getText().toString());
