...
public abstract class RxGyDownCallback extends ResponseCallback<File, ResponseBody> {
    ...
    /*tag 标志 filename 文件名称 reponse 返回的就是最后保存的文件*/
    @Override
    public void onGyNext(Object tag, String fileName, File response) {
